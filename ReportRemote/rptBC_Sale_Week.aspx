<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="rptBC_Sale_Week.aspx.cs" Inherits="ReportWeb.ReportRemote.rptBC_Sale_Week" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <p><span style="color: Maroon">Nhập khoảng thời gian cần tạo Báo cáo</span></p>
        ...
        <rsweb:ReportViewer ID="ReportViewer1" runat="server" ProcessingMode="Remote"  ZoomMode="FullPage" AsyncRendering="false" SizeToReportContent="true">
            <ServerReport ReportServerUrl="http://sktuadmin/Reportserver"  ReportPath="/Reports/rptBC_Sale_Week" />
        </rsweb:ReportViewer>
